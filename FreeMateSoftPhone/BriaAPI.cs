    ...
    public class BriaAPI
    {
        ...
        private void StartSocketClient()
        {
            ...
            if (SocketClient == null)
            {
                ...
                SocketClient.MessageReceived += new EventHandler<MessageReceivedEventArgs>(OnSocketReceivedMessage);
            }
        ...
        void OnSocketReceivedMessage(object sender, MessageReceivedEventArgs e)
        {
